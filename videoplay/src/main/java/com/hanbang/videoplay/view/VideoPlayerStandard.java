...
public class VideoPlayerStandard extends VideoPlayer {
    ...
    public void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        mProgressDialog.getWindow().getDecorView().setRotation(getRotation());
        WindowManager.LayoutParams localLayoutParams = mProgressDialog.getWindow().getAttributes();
        localLayoutParams.gravity = Gravity.CENTER_VERTICAL | (getRotation() > 80.0f ? Gravity.RIGHT : Gravity.LEFT);
    ...
    public void showVolumDialog(float deltaY, int volumePercent) {
        ...
        mVolumeDialog.getWindow().getDecorView().setRotation(getRotation());
        WindowManager.LayoutParams localLayoutParams = mVolumeDialog.getWindow().getAttributes();
        localLayoutParams.gravity = Gravity.CENTER_HORIZONTAL | (getRotation() > 80.0f ? Gravity.TOP : Gravity.BOTTOM);
